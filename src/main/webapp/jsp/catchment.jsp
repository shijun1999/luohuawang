<!-- http://localhost:8080/louhuawang/main.action -->
...
<head>
    ...
    <script>
        var myCenter = new google.maps.LatLng(49.211498, -122.942240);
                ...
                <div class="widget-box widget-color-dark">
                    <div class="widget-header">
                        <div class="widget-title bigger lighter">
                            <a href="localhostCourseList!load"><Strong style="color:white">首页&nbsp;|&nbsp;</Strong></a>
                            <a href="localhostReceivedBooking!load"><Strong style="color:white">新房&nbsp;|&nbsp;</Strong></a>
                            <a href="localhostBankInformation!load"><Strong style="color:white">出租&nbsp;|&nbsp;</Strong></a>>
                            <a href="localhostBankInformation!load"><Strong style="color:white">学区房搜索&nbsp;|&nbsp;</Strong></a>
                            <a href="localhostExclusiveDate!load"><Strong style="color:white">分析文章&nbsp;|&nbsp;</Strong></a>
                            <a href="localhostAccount!load"><Strong style="color:white">房产工具</Strong></a>
                            <br>
                        </div>
                    </div>
